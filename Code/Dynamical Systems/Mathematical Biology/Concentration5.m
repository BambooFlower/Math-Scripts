...
% To run the programme, type cons5 at the prompt sign in MATLAB; 
% the output will be a surface plot of the density over space and time.


function Concentration5
...
surf(x,t,u)    
title('Fifth Example of an Advection-Diffusion Equation')
xlabel('Distance x')
ylabel('Time t')
...
s = 1.1*u*(1-u); % gives Lc=pi*sqrt(D/f'(0))=4.3...
end
