...
// So that we can delete the fluid when we are done
...
// Equation solver using Gauss-Seidel as the numerical integration solver
...
// Force the velocity to be mass-conserving 
