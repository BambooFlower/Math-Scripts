% Simulate the 1-D Burgers' equation using the Finite Difference method
...
u = zeros(1,nx);      % Preallocate u
un = zeros(1,nx);     % Preallocate un
...
for it = 0:nt
    un = u;
    h = plot(x,u);       % Plot the velocity profile
    axis([0 2 4 6])
